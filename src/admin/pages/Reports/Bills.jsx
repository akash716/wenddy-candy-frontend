...
export default function Bills() {
    ...
    const loadBills = async () => {
        ...
        try {
            const res = await fetch(
                `http://localhost:5000/api/admin/reports/bills?start_date=${startDate}&end_date=${endDate}`
            );
    ...
    const openBill = async (bill) => {
        ...
        try {
            const res = await fetch(
                `http://localhost:5000/api/admin/reports/bills/${bill.id}`
            );
            setBillItems(await res.json());
        } catch (err) {
